...
export default function Home() {
  ...
  const submit = () => { if (query.trim()) { setScenario(/入职|新员工|账号|工位/.test(query) ? 'onboarding' : /制度|试用期|远程|请假|规定/.test(query) ? 'policy' : /报销|发票|差旅|酒店/.test(query) ? 'expense' : 'general'); setSent(true); setApproved(false); } };
