...
function AgentRun({ scenario, query, approved, onApprove, onReset }: { scenario: Scenario; query: string; approved: boolean; onApprove: () => void; onReset: () => void }) {
  ...
  return <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
    ...
    <div className="mt-7 grid gap-5 lg:grid-cols-[.72fr_1.28fr]">
      ...
      <section className="chat-thread flex min-h-[640px] flex-col">
        ...
        <div className="mt-auto pt-8"><div className="flex items-center rounded-[18px] border border-border bg-white p-2 shadow-[0_12px_42px_rgba(35,52,41,.08)]"><span className="flex-1 px-3 text-sm text-muted-foreground/65">继续输入…</span><Button size="icon" className="rounded-xl" aria-label="发送"><ArrowUp/></Button></div></div>
      </section>
    </div>
  </div>;
}
